...
IL_00f1:
	...
	}
	{
		...
		uint8_t L_58;
		L_58 = VoiceConnection_get_LogLevel_mF4895CE9505A9892B3F0E15532F1E11FAB6F3AEA(__this, /*hidden argument*/NULL);
		NullCheck(L_57);
		VoiceComponent_set_LogLevel_m58EADB81824B262AB311F518B9F2E79DE01A2596(L_57, L_58, /*hidden argument*/NULL);
	}
...
IL_0038:
	{
		...
		NullCheck(L_11);
		int32_t L_12;
		L_12 = LoadBalancingClient_get_SerializationProtocol_mBC6D3EE53982D62C3E85F1A800848286B9288F96(L_11, /*hidden argument*/NULL);
		NullCheck(L_10);
		LoadBalancingClient_set_SerializationProtocol_mDC66A52F0FB1EE73D962495FB37ECA7C6B6C8D6C(L_10, L_12, /*hidden argument*/NULL);
	}
...
IL_00df:
	{
		...
		NullCheck(L_34);
		String_t* L_35;
		L_35 = PhotonPeer_get_ServerIpAddress_mD1B46D4482C3ACA4FF443A604882198C628BAC82(L_34, /*hidden argument*/NULL);
		NullCheck(L_31);
...
IL_005d:
	{
		...
		NullCheck(L_17);
		String_t* L_18;
		L_18 = PhotonPeer_get_ServerIpAddress_mD1B46D4482C3ACA4FF443A604882198C628BAC82(L_17, /*hidden argument*/NULL);
	...
	}
	{
		...
		NullCheck(L_23);
		String_t* L_24;
		L_24 = PhotonPeer_get_ServerIpAddress_mD1B46D4482C3ACA4FF443A604882198C628BAC82(L_23, /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void VoiceDebugScript_MaxLogs_mBEC3C9618E6B9C5AACF62A36A646B848C0A823F8 (VoiceDebugScript_t74B12E50B98B548CE11602359049DBB7053791B1 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_1);
		VoiceComponent_set_LogLevel_m58EADB81824B262AB311F518B9F2E79DE01A2596(L_1, 5, /*hidden argument*/NULL);
		// PhotonVoiceNetwork.Instance.LogLevel = DebugLevel.ALL;
		IL2CPP_RUNTIME_CLASS_INIT(PhotonVoiceNetwork_t0A6BE091DA642DFFBF1BD6F8D8003D79425B8E74_il2cpp_TypeInfo_var);
		PhotonVoiceNetwork_t0A6BE091DA642DFFBF1BD6F8D8003D79425B8E74 * L_2;
		L_2 = PhotonVoiceNetwork_get_Instance_m5AEBB7F9D6C8EBD54066D34F73F836DC4EE74C50(/*hidden argument*/NULL);
		NullCheck(L_2);
		VoiceConnection_set_LogLevel_m1B2F5F6AB24002CEA508B8835A02D445095F87A6(L_2, 5, /*hidden argument*/NULL);
		// PhotonVoiceNetwork.Instance.GlobalRecordersLogLevel = DebugLevel.ALL;
		PhotonVoiceNetwork_t0A6BE091DA642DFFBF1BD6F8D8003D79425B8E74 * L_3;
		L_3 = PhotonVoiceNetwork_get_Instance_m5AEBB7F9D6C8EBD54066D34F73F836DC4EE74C50(/*hidden argument*/NULL);
		NullCheck(L_3);
		VoiceConnection_set_GlobalRecordersLogLevel_mA372D6A37AEC96D0322F30E7ADE6532138F4CDB3(L_3, 5, /*hidden argument*/NULL);
		// PhotonVoiceNetwork.Instance.GlobalSpeakersLogLevel = DebugLevel.ALL;
		PhotonVoiceNetwork_t0A6BE091DA642DFFBF1BD6F8D8003D79425B8E74 * L_4;
		L_4 = PhotonVoiceNetwork_get_Instance_m5AEBB7F9D6C8EBD54066D34F73F836DC4EE74C50(/*hidden argument*/NULL);
		NullCheck(L_4);
		VoiceConnection_set_GlobalSpeakersLogLevel_mC1DAC04C7E5F5700389F10F7D0267C502D48E0D9(L_4, 5, /*hidden argument*/NULL);
		// if (this.photonVoiceView.IsRecorder)
		PhotonVoiceView_t166ED98885509690B1E5C3AC9B08395E50EFF722 * L_5 = __this->get_photonVoiceView_5();
		NullCheck(L_5);
		bool L_6;
	...
	}
	{
		...
		NullCheck(L_8);
		VoiceComponent_set_LogLevel_m58EADB81824B262AB311F518B9F2E79DE01A2596(L_8, 5, /*hidden argument*/NULL);
	}
...
IL_0053:
	...
	}
	{
		...
		NullCheck(L_12);
		VoiceComponent_set_LogLevel_m58EADB81824B262AB311F518B9F2E79DE01A2596(L_12, 5, /*hidden argument*/NULL);
	}
...
{
	{
		...
		bool L_0 = __this->get_recordOnlyWhenEnabled_42();
		return L_0;
	}
}
IL2CPP_MANAGED_FORCE_INLINE IL2CPP_METHOD_ATTR Player_tC6DFC22DFF5978489C4CFA025695FEC556610214 * PhotonView_get_Owner_mF639C9E1BE7FB83ABC397658151CEF0317C517BF_inline (PhotonView_t946AFEDA09B2C5BE655DAA7574D432B3545FCB43 * __this, const RuntimeMethod* method)
