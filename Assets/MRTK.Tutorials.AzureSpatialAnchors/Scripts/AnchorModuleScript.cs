...
public class AnchorModuleScript : MonoBehaviour
{
 ...
 Debug.Log("\nAnchorModuleScript.RemoveLocalAnchor()");
    ...
    IEnumerator ShareAzureAnchorIdToNetworkCoroutine()
    {
        ...
        UnityWebRequest www = UnityWebRequest.Post("https://firebasestorage.googleapis.com/v0/b/lta-test-5fda8.appspot.com/o/LTA%2Fanchor", Encoding.Default.GetString(binaryData));
        /*UnityWebRequest www = UnityWebRequest.Post("https://webhook.site/ce9bad12-2bd1-4441-b655-014522550ba7", form);*/
    ...
    {
        string url = "https://firebasestorage.googleapis.com/v0/b/lta-test-5fda8.appspot.com/o/LTA%2Fanchor?alt=media" + sharingPin.ToLower();
