...
namespace LTA.Holoapp
{
    public class ModelLoader : MonoBehaviour
    {
        ...
        {
            string location = (mainCamera.transform.localPosition).ToString();
            Debug.Log(location);
            GameObject itemMenu = Instantiate(sharingMenu);
            itemMenu.transform.SetParent(mainCamera.transform);
            itemMenu.transform.localRotation = Quaternion.Euler(0,0,0);
            itemMenu.transform.localPosition = new Vector3 ((mainCamera.transform.localPosition.x), mainCamera.transform.localPosition.y, (mainCamera.transform.localPosition.z+0.5f));
