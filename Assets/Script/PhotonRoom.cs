...
namespace MRTK.Tutorials.MultiUserCapabilities
{
    public class PhotonRoom : MonoBehaviourPunCallbacks, IInRoomCallbacks
    {
        ...
        public override void OnPlayerEnteredRoom(Player newPlayer)
        {
            ...
            playersInRoom++;
            photonUserPrefab.GetComponentInChildren<Canvas>().GetComponentInChildren<Text>().text = newPlayer.NickName;
        }
        ...
        public override void OnJoinedRoom()
        {
            ...
            {
                //photonUserPrefab.GetComponentInChildren<Canvas>().GetComponentInChildren<Text>().text = photonPlayers[i].NickName;
                Debug.Log("nickname: "+ photonPlayers[i].NickName);
        ...
        private void CreateInteractableObjects()
        {
            ...
            var positionOnTopOfSurface = new Vector3(position.x, position.y + roverExplorerLocation.localScale.y,
                position.z);
